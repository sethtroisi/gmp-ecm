...
P95_URL="https://www.mersenne.org/download/software/v30/30.19/p95v3019b21.source.zip"
echo "Loading P95 version 30.19 build 21"
...
cp ./P95_stage1_file/ecmstag1.c /tmp/P95/gwnum/ecmstag1.c
