 ...
 */
int
bestD (double B2min, double B2, unsigned int *finald, unsigned int *finald2, 
       unsigned int *k, double *finali0)
{
...
bestD_po2 (double B2min, double B2, unsigned int *finald, 
           unsigned int *finald2, unsigned int *k, double *finali0)
{
