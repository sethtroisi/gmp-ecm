	  ...
	  sp_t p, sp_t d, spv_t ntt_const)
{
  ...
  {
    sp_simd_t x00 = sp_simd_gather(x, j00, inc2, n);
    sp_simd_t x01 = sp_simd_gather(x, j05, inc2, n);
    sp_simd_t x02 = sp_simd_gather(x, j10, inc2, n);
  ...
  {
    sp_simd_t x03 = sp_simd_gather(x, j03, inc2, n);
    sp_simd_t x04 = sp_simd_gather(x, j08, inc2, n);
    sp_simd_t x05 = sp_simd_gather(x, j13, inc2, n);
  ...
  {
    sp_simd_t x08 = sp_simd_gather(x, j01, inc2, n);
    sp_simd_t x06 = sp_simd_gather(x, j06, inc2, n);
    sp_simd_t x07 = sp_simd_gather(x, j11, inc2, n);
  ...
  {
    sp_simd_t x11 = sp_simd_gather(x, j04, inc2, n);
    sp_simd_t x09 = sp_simd_gather(x, j09, inc2, n);
    sp_simd_t x10 = sp_simd_gather(x, j14, inc2, n);
  ...
  {
    sp_simd_t x13 = sp_simd_gather(x, j02, inc2, n);
    sp_simd_t x14 = sp_simd_gather(x, j07, inc2, n);
    sp_simd_t x12 = sp_simd_gather(x, j12, inc2, n);
  ...
  }
  {
    ...
    sp_simd_scatter(x00, x, j00, inc2, n);
    sp_simd_scatter(x02, x, j05, inc2, n);
    sp_simd_scatter(x01, x, j10, inc2, n);
  }
  {
    ...
    sp_simd_scatter(x04, x, j01, inc2, n);
    sp_simd_scatter(x03, x, j06, inc2, n);
    sp_simd_scatter(x05, x, j11, inc2, n);
  }
  {
    ...
    sp_simd_scatter(x08, x, j02, inc2, n);
    sp_simd_scatter(x07, x, j07, inc2, n);
    sp_simd_scatter(x06, x, j12, inc2, n);
  }
  {
    ...
    sp_simd_scatter(x09, x, j03, inc2, n);
    sp_simd_scatter(x11, x, j08, inc2, n);
    sp_simd_scatter(x10, x, j13, inc2, n);
  }
  {
    ...
    sp_simd_scatter(x13, x, j04, inc2, n);
    sp_simd_scatter(x12, x, j09, inc2, n);
    sp_simd_scatter(x14, x, j14, inc2, n);
  }
}
#endif
	  ...
	  sp_t p, sp_t d, spv_t ntt_const)
{
  ...
  spv_size_t n = 15 * cofactor * stride;
  spv_size_t inc = cofactor * stride;
  spv_size_t inc2 = 15 * stride;
