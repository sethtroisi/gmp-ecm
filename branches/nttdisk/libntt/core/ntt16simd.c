		...
		sp_simd_t p, sp_simd_t * c)
{
  ...
  t3 = sp_ntt_mul_simd_core(t3, sp_simd_load(c+6), sp_simd_load(c+7), p);
  t5 = sp_ntt_mul_simd_core(t5, sp_simd_load(c+10), sp_simd_load(c+11), p);
  t6 = sp_ntt_mul_simd_core(t6, sp_simd_load(c+12), sp_simd_load(c+13), p);
  t7 = sp_ntt_mul_simd_core(t7, sp_simd_load(c+14), sp_simd_load(c+15), p);
  t9 = sp_ntt_mul_simd_core(t9, sp_simd_load(c+18), sp_simd_load(c+19), p);
  t10 = sp_ntt_mul_simd_core(t10, sp_simd_load(c+20), sp_simd_load(c+21), p);
  t11 = sp_ntt_mul_simd_core(t11, sp_simd_load(c+22), sp_simd_load(c+23), p);
  t12 = sp_ntt_mul_simd_core(t12, sp_simd_load(c+24), sp_simd_load(c+25), p);
  t13 = sp_ntt_mul_simd_core(t13, sp_simd_load(c+26), sp_simd_load(c+27), p);
  t14 = sp_ntt_mul_simd_core(t14, sp_simd_load(c+28), sp_simd_load(c+29), p);
  t15 = sp_ntt_mul_simd_core(t15, sp_simd_load(c+30), sp_simd_load(c+31), p);
  t16 = sp_ntt_mul_simd_core(t16, sp_simd_load(c+32), sp_simd_load(c+33), p);
  t17 = sp_ntt_mul_simd_core(t17, sp_simd_load(c+34), sp_simd_load(c+35), p);
		...
		sp_simd_t *w, sp_simd_t p, sp_simd_t * c)
{
  ...
  p8  = sp_ntt_twiddle_mul_simd_core(p8, sp_simd_load(w+0), sp_simd_load(w+1), p);
  p4  = sp_ntt_twiddle_mul_simd_core(p4, sp_simd_load(w+2), sp_simd_load(w+3), p);
  p15 = sp_ntt_twiddle_mul_simd_core(p15, sp_simd_load(w+4), sp_simd_load(w+5), p);
  p2  = sp_ntt_twiddle_mul_simd_core(p2, sp_simd_load(w+6), sp_simd_load(w+7), p);
  p12 = sp_ntt_twiddle_mul_simd_core(p12, sp_simd_load(w+8), sp_simd_load(w+9), p);
  p7  = sp_ntt_twiddle_mul_simd_core(p7, sp_simd_load(w+10), sp_simd_load(w+11), p);
  p11 = sp_ntt_twiddle_mul_simd_core(p11, sp_simd_load(w+12), sp_simd_load(w+13), p);
  p1  = sp_ntt_twiddle_mul_simd_core(p1, sp_simd_load(w+14), sp_simd_load(w+15), p);
  p9  = sp_ntt_twiddle_mul_simd_core(p9, sp_simd_load(w+16), sp_simd_load(w+17), p);
  p5  = sp_ntt_twiddle_mul_simd_core(p5, sp_simd_load(w+18), sp_simd_load(w+19), p);
  p14 = sp_ntt_twiddle_mul_simd_core(p14, sp_simd_load(w+20), sp_simd_load(w+21), p);
  p3  = sp_ntt_twiddle_mul_simd_core(p3, sp_simd_load(w+22), sp_simd_load(w+23), p);
  p13 = sp_ntt_twiddle_mul_simd_core(p13, sp_simd_load(w+24), sp_simd_load(w+25), p);
  p6  = sp_ntt_twiddle_mul_simd_core(p6, sp_simd_load(w+26), sp_simd_load(w+27), p);
  p10 = sp_ntt_twiddle_mul_simd_core(p10, sp_simd_load(w+28), sp_simd_load(w+29), p);
