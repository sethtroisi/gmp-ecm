	  ...
	  sp_t p, sp_t d, spv_t ntt_const)
{
  ...
  x5 = sp_simd_gather(x, j2, inc2, n);
  x6 = sp_simd_gather(x, j3, inc2, n);
  x3 = sp_simd_gather(x, j4, inc2, n);
  x2 = sp_simd_gather(x, j5, inc2, n);
  x4 = sp_simd_gather(x, j6, inc2, n);
  ...
  sp_simd_scatter(t6, x, j1, inc2, n);
  sp_simd_scatter(t4, x, j2, inc2, n);
  sp_simd_scatter(t5, x, j3, inc2, n);
  sp_simd_scatter(t2, x, j4, inc2, n);
  sp_simd_scatter(t1, x, j5, inc2, n);
