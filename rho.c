  ...
  if (argc < 2)
    {
      ...
      printf (" <B1>        B1 limit.\n");
      printf (" <B2>        B2 limit.\n");
      printf (" <N>         N of similiar size (e.g. 1e30), or number of bits in factor (if < 300).\n");
